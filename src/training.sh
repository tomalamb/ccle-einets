...
if [ "$2" == "em" ]; then  
    ...
    eval python ~/ccle-einets/src/training.py -i /disk/scratch/${USER}/ccle-einets/data/datasets -o /disk/scratch/${USER}/ccle-einets/data/output -K 32 --max_num_epochs 1 --batch_size 100 --wandb_online --wandb_project ${WANDB_PROJ} --ccle --lr 0.01 --dataset ${DATASET} --patience 8 --pd_deltas 7,28 --patch_size ${WINDOW_DIMS} --grid_sampling --grid_prob 0.8
