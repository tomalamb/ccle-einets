...
if [ ${CLL_TEST} == "y" ]; then 
    ...
    if [ ${CLL} == "y" ]; then 
        if [ ${INPAINTING} == "n" ]; then
            ...
            eval python test_ccll_evaluation.py --data_i /disk/scratch/${USER}/ccle-einets/data/datasets --model_i /disk/scratch/${USER}/ccle-einets/data/output -K 32 -o /disk/scratch/${USER}/ccle-einets/data/output --pd_deltas 7,28 --dataset ${DATASET} --patch_prob ${PATCH_PROB} --patch_size ${PATCH_DIMS} --fid
            src_path=${SCRATCH_HOME}/ccle-einets/data/output/mccle_evaluation
            dest_path=~/ccle-einets/data/output/mccle_evaluation/
            mkdir -p ${dest_path}
            ...
            eval python test_ccll_evaluation.py --data_i /disk/scratch/${USER}/ccle-einets/data/datasets --model_i /disk/scratch/${USER}/ccle-einets/data/output -K 32 -o /disk/scratch/${USER}/ccle-einets/data/output --pd_deltas 7,28 --dataset ${DATASET} --patch_prob ${PATCH_PROB} --patch_size ${PATCH_DIMS} --fid_inpaint
            src_path=${SCRATCH_HOME}/ccle-einets/data/output/mccle_evaluation
            dest_path=~/ccle-einets/data/output/mccle_evaluation
            mkdir -p ${dest_path}
        else
        ...
        if [ ${INPAINTING} == "n" ]; then
            ...
            eval python test_ccll_evaluation.py --data_i /disk/scratch/${USER}/ccle-einets/data/datasets/ --model_i /disk/scratch/${USER}/ccle-einets/data/output/ -K 32 -o /disk/scratch/${USER}/ccle-einets/data/output/ --pd_deltas 7,28 --dataset mnist --patch_prob ${PATCH_PROB} --em --fid
            ...
            # Run FID inpainting evaluation script.
            echo "Running fid inpainting script for ccle mode"
            eval python test_ccll_evaluation.py --data_i /disk/scratch/${USER}/ccle-einets/data/datasets/ --model_i /disk/scratch/${USER}/ccle-einets/data/output/ -K 32 -o /disk/scratch/${USER}/ccle-einets/data/output/ --pd_deltas 7,28 --dataset ${DATASET} --patch_prob ${PATCH_PROB} --em --fid_inpaint
            src_path=${SCRATCH_HOME}/ccle-einets/data/output/baseline_evaluation
            dest_path=~/ccle-einets/data/output/baseline_evaluation
            mkdir -p ${dest_path}
        else
